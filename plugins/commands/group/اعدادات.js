...
↫ رد بالأرقام لتغيير الإعدادات`,
        ...
        warnings: {
            antiSpam: "تحذير: السبام ممنوع",
            antiOut: "تحذير: منع الخروج مفعل",
            antiChangeGroupName: "تحذير: يمنع تغيير اسم المجموعة",
            antiChangeGroupImage: "تحذير: يمنع تغيير صورة المجموعة",
            antiChangeNickname: "تحذير: تغيير الكنيات غير مسموح",
        },
